...
namespace CIS605AS6
{
    public partial class Program14 : Form
    {
        ...
        {
            lblSmallest.Text = aAnalyzer.FindSmallestPercentageGainInPrice();
        ...
        {
            lblLargest.Text = Convert.ToString(aAnalyzer.FindLargestAbsolutePriceChange());
        ...
        {
            lblNegative.Text = Convert.ToString(aAnalyzer.FindNumTimesNegativePriceChange());
        ...
        {
            lblLongest.Text = Convert.ToString(aAnalyzer.FindLongestPriceGainStreak());
