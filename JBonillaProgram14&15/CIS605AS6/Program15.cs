...
namespace CIS605AS6
{
    public partial class Program15 : Form
    {
        ...
        {
            lblAverageScore.Text = Convert.ToString(aCard.CalcAverageScoreByPar(Convert.ToInt32(nudPar.Value)));
        ...
        {
            lblConsistentScoreHoles.Text = Convert.ToString(aCard.FindNumberOfHolesWithConsistentScore());
